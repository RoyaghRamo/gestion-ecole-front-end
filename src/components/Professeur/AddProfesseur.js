...
import { createProfesseur } from '../../actions/professeurActions';
import classnames from "classnames";

class AddProfesseur extends Component {
    ...
    onSubmit(e) {
        ...
        this.props.createProfesseur(newProfesseur, this.props.history);
    };
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            <h5 className="display-4 text-center">Formulaire: Ajouter un professeur</h5>
                            <hr />
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group">
                                    <input
                                        type="text"
                                        className={classnames("form-control form-control-lg", {
                                            "is-invalid": errors.professeurId
                                        })}
                                    ...
                                    {
                                        errors.professeurId && (
                                            <div className="invalid-feedback">{errors.professeurId}</div>
                                        )
                                    }
                                </div>
                                <input type="submit" className="btn btn-primary btn-block mt-4" value="Ajouter professeur" />
                            </form>
                        </div>
                    </div>
                </div>
